...
for (value in test_scores){
  if (test_scores >= 50){print("Passed Exam")} else {print("Failed Exam")} #tried to create and "if" and "else" statement function for the test score results, which did not end up working.
