...
Rivers.Assessed.mi2 <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(2)") %>% html_text() 
Rivers.Assessed.percent <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(3)") %>% html_text()
Rivers.Impaired.mi2 <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(4)") %>% html_text()
Rivers.Impaired.percent <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(5)") %>% html_text()
Rivers.Impaired.percent.TMDL <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(6)") %>% html_text()
...
#filter our any states with no data
Rivers <- Rivers %>%
 filter(State != "California" & State != "Hawaii" & State != "Kansas" & State != "Maryland" & State != "Missouri" & State != "Nebraska" & State != "New York" & State != "North Carolina" & State != "Ohio" & State != "Oregon" & State != "Florida")
...
```{r}
State <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(1)") %>% html_text() 
Lakes.Assessed.mi2 <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(2)") %>% html_text() 
Lakes.Assessed.percent <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(3)") %>% html_text()
Lakes.Impaired.mi2 <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(4)") %>% html_text()
Lakes.Impaired.percent <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(5)") %>% html_text()
Lakes.Impaired.percent.TMDL <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(6)") %>% html_text()
...
# 7
Lakes <- Lakes %>%
 filter(State != "California" & State != "Indiana" & State != "Kansas" & State != "Maryland" & State != "Missouri" & State != "Nebraska" & State != "Nevada" & State != "New York" & State != "North Carolina"& State != "Ohio" & State != "Oklahoma" & State != "Oregon" & State != "Tennessee" & State != "Florida" & State != "Pennsylvania")
...
```{r}
Rivers.Lakes <- full_join(Rivers, Lakes, by = c("State"))
```
