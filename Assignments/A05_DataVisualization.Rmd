...
PeterPaul.Chem.Physics <- read_csv("./Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv")
PeterPaul_Lake_Nutrients_Processed <- read_csv("./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv")
PeterPaul.chem.nutrients.gathered <-
  read.csv("./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv")

#2
PeterPaul.chem.nutrients$sampledate <- as.sampledate(PeterPaul.chem.nutrients, format = "%Y/%m/%d")
